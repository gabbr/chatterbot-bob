		...
		if (command.equals("check")) {
			...
			if (regex.length() > 0) {
				...
				try {
					...
					textArea
							.setText("Error in boolean part of regular expression (i.e., outside of the double quotes): "
									+ e.toString());
					...
					if (e.getMessage().endsWith("Expression is too large.")) {
						textArea
								.setText("Error in Perl regex part of regular expression (i.e., inside the double quotes): Pattern is too complex!\n"
						...
						textArea
								.setText("Other error in Perl regex part of regular expression (i.e., inside the double quotes):\n"
										+ e.toString());
					}
					regexArea.setBackground(Color.RED);
				}
